...
| backgroundColor.dark  | `string` in format `RRR,GGG,BBB`            | Background color for dark theme           |
| backgroundColor.light | `string` in format `RRR,GGG,BBB`            | Background color for light theme          |
